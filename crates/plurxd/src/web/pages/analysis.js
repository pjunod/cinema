...
function analysisErrorInfo(code){
  const known={
    ...
    unsupported:["VOD analysis is not supported","The file’s codec or fragment structure cannot produce a safe VOD HLS index.","Live HLS can be used when live recovery is enabled in Developer settings; rebuilding will not help unless the source changes.","bad"],
