...
**[`web/activity-stream-card`](https://github.com/pjunod/plurx/pull/849),
merged to main as `a94a32cb`, 2026-09-03.** Paul asked for the activity status display to be "a
