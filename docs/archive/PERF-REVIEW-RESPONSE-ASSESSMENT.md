...
Companion to [PERF-PLAN.md](../performance/PERF-PLAN.md) (the performance roadmap),
[ADAPTIVE-QUALITY.md](../streaming/ADAPTIVE-QUALITY.md) (the adaptive playback design),
and [PERF-PLAN-REVIEW.md](../performance/PERF-PLAN-REVIEW.md) (the original review). This
...
[PERF-PLAN.md](../performance/PERF-PLAN.md) and
[ADAPTIVE-QUALITY.md](../streaming/ADAPTIVE-QUALITY.md):
...
9. **Fix document links.** The submitted response names
   ...
   [PERF-PLAN-REVIEW.md](../performance/PERF-PLAN-REVIEW.md).
