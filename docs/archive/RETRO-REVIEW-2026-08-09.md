...
Companion work orders (one per subject, sized for a GPT agent) live in `docs/archive/retro-2026-08-09/WO-01 … WO-11`. Each is self-contained: context, file:line evidence at the pinned sha, exact tasks, acceptance checks.
...
[`docs/archive/retro-2026-08-09/EXTERNAL-REVIEW-HANDOFF.md`](retro-2026-08-09/EXTERNAL-REVIEW-HANDOFF.md).
