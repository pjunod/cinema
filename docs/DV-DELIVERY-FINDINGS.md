...
**Stale doc:** `docs/MEDIA-BADGES-PLAN.md` (~line 340) still says "DV P7
...
software-decode bug in `docs/STUTTER-4K.md`), and `fragindex.rs:258-265`
...
already carries it (`docs/MEDIA-BADGES-PLAN.md`). Buys nothing in picture
quality.
...
- **Do not change strip/tonemap behaviour while chasing the badge.** The
  reporter/decider split in `docs/MEDIA-BADGES-PLAN.md` §9 exists for a reason.
