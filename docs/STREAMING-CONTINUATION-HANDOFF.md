...
**Keep the status page updated** — `docs/STREAMING-RELIABILITY-STATUS.md`,
...
| [#160](http://192.168.4.7:3000/noirr/plurx/pulls/160) / [#161](http://192.168.4.7:3000/noirr/plurx/pulls/161) | `docs/CLIENT-PREPARED-SWITCH-CONTRACT.md`, the client adapters' brief |
...
reasoning is in `docs/STREAMING-RELIABILITY-HANDOFF.md` §4's banner; the
...
`docs/CLIENT-PREPARED-SWITCH-CONTRACT.md` and nothing else. **Apple first** —
