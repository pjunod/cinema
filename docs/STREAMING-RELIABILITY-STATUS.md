...
| Corrective task PRs | **Active — [#908 playback evidence](https://github.com/pjunod/plurx/pull/908) merged; [#911 client recovery](https://github.com/pjunod/plurx/pull/911) open** | Evidence head `73d9bab7` passed exact-head adversarial review and merged as `7db47b35`. PR #911 closes open Android buffering freezes, unbounded Apple/web control deferral, stale owner asks, web terminal-verdict lifetime, Android playback identity/quality truth, and pending seek intent. Focused proof is green: full web contract, Android JVM units, and 274 Apple simulator tests; the effort-mode commit gate is green | Exact-head adversarial approval and Effort development gate green |
