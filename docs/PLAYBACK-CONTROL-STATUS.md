...
with no remaining P0–P3 finding. The remote PR remains at `c48a9867` until the
corrected documentation tip passes immutable review and is pushed.
...
green. Corrected-tip review, push, a wholly green hosted rerun, and merge
remain.
