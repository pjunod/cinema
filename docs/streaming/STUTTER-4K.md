...
**Companions:** [PERF-PLAN.md](../performance/PERF-PLAN.md) §4.3bis (the routing that
...
[PHASE3-SPIKE.md](../cluster/PHASE3-SPIKE.md). A copy-path-only override has to enter
