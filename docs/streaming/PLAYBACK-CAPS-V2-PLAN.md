...
- **A second finding here was retracted.** An earlier revision claimed the
  ...
  an argv plurx never runs. See `docs/streaming/PLAYBACK-CAPS-V2-M0.md` §8.
...
required, and the box is `dvvC` (`docs/streaming/PLAYBACK-CAPS-V2-M0.md` §8). Then: `dolby_vision` crate dependency; `DvConvert` on
