...
[PLAYBACK-CONTROL-PROTOCOL-PLAN.md](../playback-control/PLAYBACK-CONTROL-PROTOCOL-PLAN.md)
...
| P3-2 | Stale comments at [`http/hls.rs`](../../crates/plurxd/src/http/hls.rs#L5392); stale milestone/current-state claims in [PLAYBACK-CONTROL-STATUS.md](../playback-control/PLAYBACK-CONTROL-STATUS.md); false cutover claim in [VOD-CUTOVER.md](VOD-CUTOVER.md) |
