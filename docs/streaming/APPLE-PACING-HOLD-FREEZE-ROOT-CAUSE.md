...
window work),
[M5-CLIENT-ACTION-OWNERSHIP-HANDOFF.md](../playback-control/M5-CLIENT-ACTION-OWNERSHIP-HANDOFF.md)
(why clients began obeying server actions), and
[PLAYBACK-CONTROL-STATUS.md](../playback-control/PLAYBACK-CONTROL-STATUS.md) (the rollout state).
...
in [AGENT-COMPILE-LOOP.md](../ci/AGENT-COMPILE-LOOP.md). Retain:
