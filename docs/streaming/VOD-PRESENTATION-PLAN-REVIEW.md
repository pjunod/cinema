...
[PERF2-PLAN-REVIEW.md](../performance/PERF2-PLAN-REVIEW.md) (the measured restart-timestamp
seam), and [CLUSTERING-PLAN.md](../cluster/CLUSTERING-PLAN.md) (the accepted takeover
...
recorded in [PERF2-PLAN-REVIEW.md](../performance/PERF2-PLAN-REVIEW.md) §2 R1 already proved
...
50 GB budget ([PERF-PLAN.md](../performance/PERF-PLAN.md):1675-1678). The plan itself uses a
...
[CLUSTERING-PLAN.md](../cluster/CLUSTERING-PLAN.md), and its accepted contract conflicts
...
non-byte-identical output ([CLUSTERING-PLAN.md](../cluster/CLUSTERING-PLAN.md):305-327,
...
- Replace the nonexistent `CLUSTER-MEDIA-POOL-PLAN.md` reference with the
  applicable [CLUSTERING-PLAN.md](../cluster/CLUSTERING-PLAN.md) section after B5 is
  resolved.
