...
the segmenter costs nothing and gains nothing there, and `docs/streaming/STUTTER-4K.md`
...
4. `docs/streaming/STUTTER-4K.md` §5.6 and `CHANGELOG.md` updated in the same commits
...
- `docs/streaming/STUTTER-4K.md`: add §5.6 (the segmenter: what shipped, the M2
...
5. **This segmenter milestone makes no changes to rescue thresholds, routing
   ...
   [PERF-PLAN.md](../performance/PERF-PLAN.md) §4.3bis rather than retrofitted here.
