...
| [TRON-WEB-HELD-SEEK-STALL-RCA.md](streaming/TRON-WEB-HELD-SEEK-STALL-RCA.md) | Why one held seek produced two client commits and spent recovery before the refilled attachment could prove presentation progress. | open |
