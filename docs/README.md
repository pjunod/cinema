...
| File | Answers | |
|---|---|---|
| [OPTICAL-MEDIA-IMPLEMENTATION.md](features/OPTICAL-MEDIA-IMPLEMENTATION.md) | Milestone contract for physical DVD and Blu-ray playback through the existing VOD controller, rebased onto advisory Developer enablement. | open |
| [Optical media implementation status](features/OPTICAL-MEDIA-STATUS.html) | Live branch, milestone, evidence, review and promotion ledger for the optical-media effort. | open |
| [Optical M0 evidence](evidence/OPTICAL-M0-2026-09-20.md) | Exact compiler, local FFmpeg capability, hardware reachability and source-input decisions; physical seek acceptance remains open. | open |
| [Optical M1 evidence](evidence/OPTICAL-M1-2026-09-20.md) | Common source facts, versioned optical session identity, SQLite/Hiqlite persistence, grants, cleanup, and focused migration evidence. | built |
| [Optical M2 evidence](evidence/OPTICAL-M2-2026-09-20.md) | Configured-drive lifecycle, insertion fencing, bounded helper protocol, conditional observation, reader admission, eject, and remaining physical-host gaps. | built |
| [Optical M3 managed-source audit](evidence/OPTICAL-M3-SOURCE-AUDIT-2026-09-21.md) | Required disposition of file/source consumers for managed optical playback; encoded VOD is wired while copy/index and physical acceptance remain open. | open |
| [Optical helper packaging evidence](evidence/OPTICAL-HELPER-PACKAGING-2026-09-21.md) | Linux helper parsing boundaries, installed binary paths, release-manifest integration, operator setup and remaining physical-media qualification. | built |
| [Optical M4 ownership evidence](evidence/OPTICAL-M4-2026-09-21.md) | Protocol-fenced, path-free drive-owner advertisements, fresh remote discovery, typed no-relay refusal and remaining cluster playback work. | open |
| [Optical M6 native-client evidence](evidence/OPTICAL-M6-2026-09-21.md) | Apple and Android optical wire/navigation plus shared-player adapters and compile-only evidence; physical-device acceptance remains open. | open |
