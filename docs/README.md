...
| [Optical M6 native-client evidence](evidence/OPTICAL-M6-2026-09-21.md) | Apple and Android optical wire/navigation/playback flow plus compile-only evidence; shared-player and physical-device acceptance remain open. | open |
