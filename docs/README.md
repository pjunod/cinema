...
| [LIVE-TV-DVR-VISIBILITY-STATUS.md](features/LIVE-TV-DVR-VISIBILITY-STATUS.md) | Live progress for programme recording badges, capture observations, lifecycle history, Activity details and the permanent Recordings destination across web, Apple and Android. | open |
