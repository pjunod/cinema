...
| [PGS-SUBTITLE-START-PATH-RCA-AND-PLAN.md](clients/PGS-SUBTITLE-START-PATH-RCA-AND-PLAN.md) | Why a 79.5 GB read blocks a start when a title needs PGS burn-in, what the 2026-09-21 incident actually was, and the three fixes — two merged, the overlay gate still off. | open |
