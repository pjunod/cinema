...
[CODE-QUALITY-PERFORMANCE-REVIEW.md](../performance/CODE-QUALITY-PERFORMANCE-REVIEW.md). It
...
2. **Subtitles are the most expensive menu in both apps** (§3). Both clients
   ...
   original PGS-burn cascade (see `docs/streaming/STUTTER-4K.md` era fixes) alive in
   the native clients.
