...
measured), [PERF-PLAN.md](../performance/PERF-PLAN.md) §7.3 (the session-takeover contract
...
[PERF-PLAN.md](../performance/PERF-PLAN.md) §7.3 already specified after its own review, and
...
[PERF-PLAN.md](../performance/PERF-PLAN.md) §7.3 defines this handoff already, after its own
...
(`docs/performance/PERF-PLAN.md:8-9`), this freezes the plumbing without the fields its
...
sweep, so neither is false — but [OFFLINE-VIEWING-PLAN.md](../clients/OFFLINE-VIEWING-PLAN.md)
...
[OPERATIONS.md](../OPERATIONS.md) and [PERF-PLAN.md](../performance/PERF-PLAN.md) §6.4 — that
...
[APPLE-NATIVE-SUBTITLES-PLAN.md](../clients/APPLE-NATIVE-SUBTITLES-PLAN.md):659-661
still carries the unchecked box, and the only deployment ledger in the tree
([APPLE-NATIVE-SUBTITLES-HANDOFF.md](../clients/APPLE-NATIVE-SUBTITLES-HANDOFF.md):339-341,
[APPLE-CLIENT-PARITY.md](../clients/APPLE-CLIENT-PARITY.md):18-20) still has every node
...
defensible as written (see §9), but [APPLE-CLIENT-PARITY.md](../clients/APPLE-CLIENT-PARITY.md)
is stamped 2026-08-02 and still lists offline as "Missing" (`:68`) and the
fleet as behind (`:19-21`), and
[APPLE-NATIVE-SUBTITLES-PLAN.md](../clients/APPLE-NATIVE-SUBTITLES-PLAN.md):577-578
...
- **"The Apple row's PGS claim is false."** It is not. The row is badged
  ...
  [PGS_OVERLAY_PLAN.md](../clients/PGS_OVERLAY_PLAN.md):1090-1093 calls the client
