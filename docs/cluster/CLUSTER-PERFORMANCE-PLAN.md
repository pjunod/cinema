...
[PERF2-PLAN.md](../performance/PERF2-PLAN.md) (playback-path performance) — this plan makes a
...
`docs/cluster/CLUSTERING-PLAN.md`, and `docs/OPERATIONS.md`. P0a/P0b are reconstructed
