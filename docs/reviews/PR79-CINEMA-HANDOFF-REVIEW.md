...
[CLUSTERING-PLAN-REVIEW.md](../cluster/CLUSTERING-PLAN-REVIEW.md), whose eight blocking
contracts this PR answers

[pr79]: https://github.com/pjunod/plurx/pull/79

Companion to [CLUSTERING-PLAN-REVIEW.md](../cluster/CLUSTERING-PLAN-REVIEW.md) (what the
...
`docs/performance/PERF-PLAN.md:3-8` sides with STATUS ("M1, M2 and M3 complete
...
vars, both default off; `docs/clients/APPLE-NATIVE-SUBTITLES-PLAN.md:619-620`
