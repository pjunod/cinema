...
**Status:** PR #506 merged; six Apple installs complete; two of four nodes verified · **Updated:** 2026-09-25 04:56 UTC · **Main:** `44cdfccc7`
...
| Main deployment and fleet evidence | At 04:56 UTC `nynuc` and `m6` ran merged main `44cdfccc7`, each healthy with zero restarts and `/readyz` 200; `nuc4` is being rebuilt next and `nuc3` still has an earlier build. The first-hour collector had a 337 s gap and two `nuc3` refusals; expected connection refusals during the serial rollout are retained in the raw series. Signed Apple Release build 183 is installed on 17air, 17promax, Bedroom Apple TV, iPad Mini, iPad Pro and iPhone; Bedroom, iPad Pro and iPhone launched, while the other three were locked. Install log: `/Users/pjunod/code/plurx-agent/codex-postmerge-apple-deploy-20260925.log` | Finish four-node rollout; collect device and long-window acceptance; Android release-signing inputs remain absent | [Dated fleet evidence](ARCHITECTURE-REVIEW-FLEET-EVIDENCE-2026-09-24.md), [fleet/client baselines](ARCHITECTURE-REVIEW-FLEET-CLIENT-BASELINES-2026-09-25.md), [fleet readout](ARCHITECTURE-REVIEW-FLEET-READOUT-2026-09-25.md) and deployment logs |
