...
| A-02 · Apple controller | 5.1-5.6 code integrated on draft #506 through `fe204f789`; combined iOS/tvOS compilation passed | One final review and fast lane when the full PR is ready; physical remote-control acceptance remains | Plan execution log and workboard row |
