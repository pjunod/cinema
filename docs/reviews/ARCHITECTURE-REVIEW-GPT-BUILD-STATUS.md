...
| A-03 · Native library paging | 5.2-5.5 code on `codex/a03-library-paging-restore`; Apple iOS/tvOS and Android app/test-source compilation passed | Integrate into draft #506, then one review, fast lane and Apple TV/Lenovo evidence | Plan execution log and workboard row |
