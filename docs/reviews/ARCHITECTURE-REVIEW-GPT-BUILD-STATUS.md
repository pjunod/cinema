...
**Status:** open · **Updated:** 2026-09-25 02:21 UTC · **Base:** `f600d2823`
...
|---|---|---|---|
| D-02 · Android lifecycle | M1-M5 and M7-M9 integrated on [draft PR #506](http://192.168.4.7:3000/noirr/plurx/pulls/506) through `5829810bc`; production and test Kotlin compilation in progress. Notification Pause while already owner-paused needs Pixel validation | Finish integration compile, one final review, fast lane and §5.6 device checks | Plan execution log and workboard row |
...
| L-03 · Shared Live TV transport | M2 capacity offers integrated; three M3 captures established CC1 and 708 SERVICE1 dialogue. Prompt C Chrome baseline showed an English hidden track with no text drawn for >30 s | Finish M4 per-build probe and native prompt C/client device passes | Plan execution log, workboard row and dated fleet evidence |
