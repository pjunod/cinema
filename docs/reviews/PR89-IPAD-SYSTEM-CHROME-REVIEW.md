...
Companion to [APPLE-CLIENT-PARITY.md](../clients/APPLE-CLIENT-PARITY.md) (the matrix this
...
| `docs/clients/APPLE-CLIENT-PARITY.md:12` | `Status (2026-08-06): source is v0.2.7, Apple build 32.` | 36, 2026-08-08 |
| `docs/clients/APPLE-NATIVE-SUBTITLES-PLAN.md:381` | `The next Apple upload is build 32 or higher` | ≥36 |
...
`docs/clients/APPLE-NATIVE-SUBTITLES-PLAN.md:461-462` ("update `CHANGELOG.md`
`[Unreleased]` and the status page (`docs/STATUS.html`) in the same commits as
the behavior they describe") and `docs/clients/OFFLINE-VIEWING-REVIEW.md:727-728`
...
Also under-describing the iOS player now: `docs/clients/APPLE-CLIENT-PARITY.md:50`
...
- **`docs/clients/APPLE-NATIVE-SUBTITLES-PLAN.md:656`** asserts `STATUS.html` was
