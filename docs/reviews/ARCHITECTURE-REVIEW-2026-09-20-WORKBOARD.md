...
| C-05 | [DETAIL-READS-AND-STORAGE-AVAILABILITY](../server/DETAIL-READS-AND-STORAGE-AVAILABILITY.md) | C14 | month | in-progress | gpt-5.6-sol | agent:/root/p01_builder | [PR #435](http://192.168.4.7:3000/noirr/plurx/pulls/435) | 2026-09-21 | One plan PR; M1 is the first logical commit and its deployed/backfilled intermediate SHA is mandatory before M2 promotion. Cost and backfill stay node-local in the sidecar, never Raft. |
