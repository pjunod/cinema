...
| K-01 | [CLUSTER-BACKUP-AND-RESTORE](../cluster/CLUSTER-BACKUP-AND-RESTORE.md) | §2.3, S4 | month | in-progress | gpt-5.6-sol | agent:/root/s01_builder | [PR #426](http://192.168.4.7:3000/noirr/plurx/pulls/426) | 2026-09-21 | M1 implemented. Whole-plan draft; physical restore and fleet evidence remain explicit until observed. |
