...
| K-05 | [SQLITE-READ-PATH-AND-QUERY-PLANS](../cluster/SQLITE-READ-PATH-AND-QUERY-PLANS.md) | S6, S7, S11 | month | claimed | gpt-5.6-sol | agent:/root/c02_builder | `plan/K-05` | 2026-09-21 | Whole-plan draft; M0 evidence precedes query changes, and search uses the corrected `classification_fts` predicate. |
