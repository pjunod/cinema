...
| S-04 | [FONT-ATTESTATION-AND-BLOCKING-IO](../streaming/FONT-ATTESTATION-AND-BLOCKING-IO.md) | §2.7 | week (M1) / month (M2) | claimed | gpt-5.6-sol | agent:/root/p01_builder | `plan/S-04` | 2026-09-21 | Claim opened; read-only media1 `ldd \| grep fontconfig` evidence precedes the M2 decision. |
