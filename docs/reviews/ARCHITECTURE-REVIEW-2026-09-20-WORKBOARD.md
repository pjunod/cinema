...
| K-01 | [CLUSTER-BACKUP-AND-RESTORE](../cluster/CLUSTER-BACKUP-AND-RESTORE.md) | §2.3, S4 | month | claimed | gpt-5.6-sol | agent:/root/s01_builder | `plan/K-01` | 2026-09-21 | Whole-plan draft; the procedure is the deliverable. Physical restore and fleet evidence remain explicit until observed. |
