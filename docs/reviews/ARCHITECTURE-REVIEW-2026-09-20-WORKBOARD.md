...
| S-02 | [MEDIA-BODY-BUFFERS](../streaming/MEDIA-BODY-BUFFERS.md) | §2.4, C1 | week | claimed | gpt-5.6-sol | agent:/root/c02_builder | `plan/S-02` | 2026-09-21 | M1 only this week; M2 (ack batching) stays pending in this plan PR until the required deployed measurement exists. |
