...
| S-05 | [FFMPEG-SPAWN-UNIFICATION](../streaming/FFMPEG-SPAWN-UNIFICATION.md) | F-stream-12/13, §4.1 | month | blocked: fleet evidence | gpt-5.6-sol | agent:/root/p01_builder | [`plan/S-05` · draft #415](http://192.168.4.7:3000/noirr/plurx/pulls/415) | 2026-09-21 | M1/M2 implemented; M3 needs the deployed encoded-burn and progressive-remux environment/TTFF check. No feature gate or enablement setting. |
