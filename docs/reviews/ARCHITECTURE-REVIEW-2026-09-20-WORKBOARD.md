...
| S-04 | [FONT-ATTESTATION-AND-BLOCKING-IO](../streaming/FONT-ATTESTATION-AND-BLOCKING-IO.md) | §2.7 | week (M1) / month (M2) | blocked: M2 config isolation design | gpt-5.6-sol | agent:/root/p01_builder | [PR #413](http://192.168.4.7:3000/noirr/plurx/pulls/413) | 2026-09-21 | M1 built at `da0b96a7`; media1 links fontconfig, but the active root/user configs contain live discovery directives, so M2's literal byte-copy layout is not frozen. §7 records the required design correction and decisions. |
