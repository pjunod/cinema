...
| S-11 | [CODEC-AND-GPU-QUALIFICATION](../streaming/CODEC-AND-GPU-QUALIFICATION.md) | Q12, Q6, Q8 | quarter | claimed | gpt-5.6-sol | agent:/root/c02_builder | [`plan/S-11` / draft](http://192.168.4.7:3000/noirr/plurx/pulls) | 2026-09-21 | M0 encoder inventory runs first; its configured/probe-accepted/selected/used evidence decides whether NVENC and VideoToolbox milestones exist. |
