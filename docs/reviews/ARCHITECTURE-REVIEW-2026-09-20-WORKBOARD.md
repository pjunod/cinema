...
| K-04 | [BOUNDED-REPLICA-READS-ROLLOUT](../cluster/BOUNDED-REPLICA-READS-ROLLOUT.md) | S1 | month | claimed | gpt-5.6-sol | agent:/root/c02_builder | plan/K-04 | 2026-09-21 | Whole-plan draft; consistency-policy change; no auth cache |
