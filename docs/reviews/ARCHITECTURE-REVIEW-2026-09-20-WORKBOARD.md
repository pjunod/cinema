...
| S-12 | [VOD-BFRAMES-TIMELINE-DESIGN](../streaming/VOD-BFRAMES-TIMELINE-DESIGN.md) | Q2 | design | blocked: fleet/device evidence | gpt-5.6-sol | agent:/root/p01_builder | [`plan/S-12` · draft #423](http://192.168.4.7:3000/noirr/plurx/pulls/423) | 2026-09-21 | D0–D3 plus sole-review P1 complete in `625a6ed8`: Option C stays deployed; the v2 oracle now binds video-track timescale to the plan, refuses edit lists, and separates runtime-resolved facts from raw B0 box evidence. B0–B4 still await real ffmpeg 6/8, per-family quality/init/restart, Paul decision and client evidence. No Rust, recipe, setting, feature gate or enablement changed. |
...
| K-06 | [CLOCK-SKEW-GUARD-DESIGN](../cluster/CLOCK-SKEW-GUARD-DESIGN.md) | S9 | design | in-progress | gpt-5.6-sol | agent:/root/p01_builder | [PR #430](http://192.168.4.7:3000/noirr/plurx/pulls/430) | 2026-09-21 | M0-M4 design boundary and sole-review disposition complete through `1318972bb`: wall/monotonic generation rechecks close local/common-mode step races; admission is distinct from fenced target removal; RTT filtering has a floor and time expiry. Runtime/fleet evidence remain explicitly blocked and no second review is requested. |
