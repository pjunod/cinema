...
| S-02 | [MEDIA-BODY-BUFFERS](../streaming/MEDIA-BODY-BUFFERS.md) | §2.4, C1 | week | in-progress | claude-opus-5 | https://claude.ai/code/session_01AZemhL7Y1nXGWxUGRC2tkK | [PR #410](http://192.168.4.7:3000/noirr/plurx/pulls/410) | 2026-09-22 | M1 implemented; sole adversarial review dispositioned. The 256 KiB read had carried the pump's delivery-proof granularity with it; `MEDIA_BODY_ACK_GRANULARITY` now holds the proof at 4 KiB and the full `plurxd` binary target is green. lab4 before/after acceptance pending, now including a small-object concurrency group. M2 stays pending in this PR until the one-week media1 telemetry prerequisite exists. |
...
| S-04 | [FONT-ATTESTATION-AND-BLOCKING-IO](../streaming/FONT-ATTESTATION-AND-BLOCKING-IO.md) | §2.7 | week (M1) / month (M2) | blocked: M2 config isolation design | gpt-5.6-sol | agent:/root/p01_builder | [PR #413](http://192.168.4.7:3000/noirr/plurx/pulls/413) | 2026-09-22 | M1 built at `da0b96a7`; the adversarial review's two findings are fixed at `d5487ef4`, which folds the encoder executable into the attestation batch instead of statting it inline ahead of it, and labels the four attestation series by what each batch stats, once per check. M2 stays blocked: media1 links fontconfig, but the active root/user configs contain live discovery directives, so M2's literal byte-copy layout is not frozen. §7 records the required design correction and decisions. |
...
| S-06 | [ENCODER-RATE-CONTROL-DEFAULTS](../streaming/ENCODER-RATE-CONTROL-DEFAULTS.md) | Q1 | month | blocked: fleet evidence | gpt-5.6-sol | agent:/root/p01_builder | [`plan/S-06` / #414](http://192.168.4.7:3000/noirr/plurx/pulls/414) | 2026-09-22 | M1/M2/M5 implemented; the adversarial review's three findings are fixed. M1's speculative dedupe key spells an unset pair `bitrate` again, so no queue row is cancelled at deploy or mid-boot. Every pinned n2/n1 fixture is bit-exact, seeded and single-threaded, and both manifests are re-pinned from generations that agree across core counts. The harness refuses an HDR source while the scorer has no tone-map. QSV and software remain Bitrate; M3/M4 need read-write n2 captures on reserved deployed nodes. No universal maxrate cap. |
...
| S-13 | [DECODE-FACTS-GATE-AND-FALLBACK](../streaming/DECODE-FACTS-GATE-AND-FALLBACK.md) | C13 | month | blocked: fleet evidence | gpt-5.6-sol | agent:/root/s01_builder | [PR #424](http://192.168.4.7:3000/noirr/plurx/pulls/424) | 2026-09-21 | M0-M2 implemented and focused-green; sole review comment 3333 is dispositioned with keyed hit-only measurements, cleanup-owned timing, real `CatalogRow` fallback coverage, and VOD/pretranscode caller-contract coverage. M0 production-static-binary measurements and M1 lab warning evidence remain pending; those measurements decide whether M3/M4 open. |
| S-14 | [TRANSCODE-DECOMPOSITION-PLAN](../streaming/TRANSCODE-DECOMPOSITION-PLAN.md) | §4.1, §4.2, §4.9 | quarter | in-progress | gpt-5.6-sol | agent:/root/c02_builder | [PR #425](http://192.168.4.7:3000/noirr/plurx/pulls/425) | 2026-09-21 | M0-M1 and M2/T2 complete: baselines, inline-test extraction, and segment-index leaf move. T3-T7 remain next; registry unification remains a separate evaluation. |
| K-01 | [CLUSTER-BACKUP-AND-RESTORE](../cluster/CLUSTER-BACKUP-AND-RESTORE.md) | §2.3, S4 | month | in-review | gpt-5.6-sol | agent:/root/s01_builder | [PR #426](http://192.168.4.7:3000/noirr/plurx/pulls/426) | 2026-09-21 | Sole review #3366 addressed: ordinal-5 wire compatibility, DVR/session cleanup, read-only fail-closed key handling, success-only scheduler fencing, and executable M2/M3 acceptance are focused-green. M4 container drill and M5 physical lab/NAS RPO/RTO evidence remain explicitly pending; no second review is requested. |
| K-02 | [RAFT-SNAPSHOT-CADENCE-AND-CONSISTENT-CUT](../cluster/RAFT-SNAPSHOT-CADENCE-AND-CONSISTENT-CUT.md) | S2, S5 | month | in progress: M0 instrumentation | gpt-5.6-sol | agent:/root/p01_builder | [PR #427](http://192.168.4.7:3000/noirr/plurx/pulls/427) | 2026-09-21 | M0 gauges and Cluster-page DB bytes implemented. Mandatory every-voter 24 h readout and prepared follower replay are blocked by fleet reachability/operational authority; M1-M3 intentionally unchanged. |
...
| K-04 | [BOUNDED-REPLICA-READS-ROLLOUT](../cluster/BOUNDED-REPLICA-READS-ROLLOUT.md) | S1 | month | blocked: fleet evidence | gpt-5.6-sol | agent:/root/c02_builder | [PR #428](http://192.168.4.7:3000/noirr/plurx/pulls/428) | 2026-09-21 | Sole-review findings addressed: exact route/role attribution and fail-closed M1 call inventory are focused-green. Run the §5.1 lab1–lab3 readout before M2; M2 also needs the acknowledged Raft index surfaced by the write response. Default stays false; no auth cache. |
| K-05 | [SQLITE-READ-PATH-AND-QUERY-PLANS](../cluster/SQLITE-READ-PATH-AND-QUERY-PLANS.md) | S6, S7, S11 | month | blocked: M0 query-plan evidence | gpt-5.6-sol | agent:/root/c02_builder | [PR #429](http://192.168.4.7:3000/noirr/plurx/pulls/429) | 2026-09-21 | Generator `d87861a1` produced a 1.74 GiB semantic standalone fixture with all four Home rails, populated Recordings and executable ownership census; M0 still needs an actual Hiqlite state-machine fixture, both-backend plans/timings and the contention matrix. No query/read-path code started. |
...
| K-08 | [HIQLITE-FORK-AND-DEPENDENCY-CLEANUP](../cluster/HIQLITE-FORK-AND-DEPENDENCY-CLEANUP.md) | §4.3 | month | blocked: lab and upstream evidence | gpt-5.6-sol | agent:/root/s01_builder | [PR #432](http://192.168.4.7:3000/noirr/plurx/pulls/432) | 2026-09-21 | M1 and the safe M2 boundary are implemented: preserve patch-by-name, remove only cryptr/S3, and map both surviving aws-lc routes. M0 timings, M3 provider/fleet proof, M4 corpus equivalence, conditional M5, and M6 public upstream links remain explicit. |
...
| C-03 | [IMAGE-SERVING-AND-DERIVATIVES](../server/IMAGE-SERVING-AND-DERIVATIVES.md) | C6 | month | blocked: fleet evidence | gpt-5.6-sol | agent:/root/p01_builder | [PR #431](http://192.168.4.7:3000/noirr/plurx/pulls/431) | 2026-09-21 | M1-M2 are implemented with focused tests; §6.2-§6.4 lab concurrency, browser-byte and physical-device evidence remain. `original` backdrops are unchanged. |
| C-04 | [AUTH-HARDENING](../server/AUTH-HARDENING.md) | C7, C8 | month | implemented: M1-M3; M4 decision; review pending | gpt-5.6-sol | agent:/root/s01_builder | [PR #433](http://192.168.4.7:3000/noirr/plurx/pulls/433) | 2026-09-21 | Fence preserved. Non-expiring tokens retained until client recovery is qualified; device inventory/revocation is the compensating control. Three-node simultaneous logout and fleet proxy observations remain deployment evidence. |
| C-05 | [DETAIL-READS-AND-STORAGE-AVAILABILITY](../server/DETAIL-READS-AND-STORAGE-AVAILABILITY.md) | C14 | month | in-progress | gpt-5.6-sol | agent:/root/p01_builder | [PR #435](http://192.168.4.7:3000/noirr/plurx/pulls/435) | 2026-09-21 | M1 is pushed at exact deployable boundary `33e66cfd1`; focused marker/backfill/migration/metrics checks are green. M2/M3 remain pending. M2 must not be implemented or promoted until that exact M1 SHA has a deployed/backfilled receipt. Cost and backfill stay node-local in the sidecar, never Raft. |
| C-06 | [TELEMETRY-BACKPRESSURE](../server/TELEMETRY-BACKPRESSURE.md) | C15 | month | in-progress | gpt-5.6-sol | agent:/root/c02_builder | [PR #434](http://192.168.4.7:3000/noirr/plurx/pulls/434) | 2026-09-21 | M1-M4 implemented with focused source evidence. Draft is ready for its sole adversarial review; §6.3 fleet stall/restart measurements remain pending and are not claimed. |
...
| A-01 | [APPLE-DISPLAY-CRITERIA-AND-AUDIO-SESSION](../clients/APPLE-DISPLAY-CRITERIA-AND-AUDIO-SESSION.md) | §2.8, §2.10 | week | blocked: device evidence | gpt-5.6-sol | agent:/root/c02_builder | [PR #406](http://192.168.4.7:3000/noirr/plurx/pulls/406) | 2026-09-21 | M1–M3 implementation is complete and all findings from sole adversarial review #3154 are addressed; five focused iOS simulator tests, tvOS compile, surface contract, and docs checks pass. Apple TV HDMI and iPhone interruption prompts remain device evidence before merge/done. |
