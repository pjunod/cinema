...
| S-07 | [TONE-MAP-CHAIN-CORRECTIONS](../streaming/TONE-MAP-CHAIN-CORRECTIONS.md) | Q3 | month | blocked: M2 image + M3 fleet evidence | gpt-5.6-sol | agent:/root/c02_builder | [`plan/S-07` / #416](http://192.168.4.7:3000/noirr/plurx/pulls/416) | 2026-09-21 | M0–M1 complete. M2 source and focused regressions are green, but required lab4, 10/50/90 and Harbor Lights still/histogram evidence remains pending. M3 then needs the merged/coordinated-schema build deployed to media1, before/after pipeline verdicts, and Apple TV/Chrome playback observations; draft branch code was not deployed. |
