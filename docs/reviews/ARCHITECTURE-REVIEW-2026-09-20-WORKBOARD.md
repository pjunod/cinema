...
| S-03 | [ENCODED-VOD-HOLD-AND-RELEASE](../streaming/ENCODED-VOD-HOLD-AND-RELEASE.md) | §2.6 | week | implementing | gpt-5.6-sol | agent:/root/s01_builder | [PR #412](http://192.168.4.7:3000/noirr/plurx/pulls/412) | 2026-09-21 | M0 controlled before-counts remain fleet evidence; M1 low-water scheduler is implemented with focused pinned-toolchain evidence. |
