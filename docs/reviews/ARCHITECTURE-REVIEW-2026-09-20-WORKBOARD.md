...
| C-06 | [TELEMETRY-BACKPRESSURE](../server/TELEMETRY-BACKPRESSURE.md) | C15 | month | in-progress | gpt-5.6-sol | agent:/root/c02_builder | [PR #434](http://192.168.4.7:3000/noirr/plurx/pulls/434) | 2026-09-21 | M1 bounded writer and one-lease batch persistence implemented first; M2-M4 remain in this draft. |
