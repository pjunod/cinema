...
| S-12 | [VOD-BFRAMES-TIMELINE-DESIGN](../streaming/VOD-BFRAMES-TIMELINE-DESIGN.md) | Q2 | design | blocked: fleet/device evidence | gpt-5.6-sol | agent:/root/p01_builder | [`plan/S-12` · draft #423](http://192.168.4.7:3000/noirr/plurx/pulls/423) | 2026-09-21 | D0–D3 design complete in `868fd806`: Option C stays deployed; Option A is the sole admissible future candidate and has an executable presentation-grid oracle. B0–B4 await real ffmpeg 6/8, per-family quality/init/restart, Paul decision and client evidence. No Rust, recipe, setting, feature gate or enablement changed. |
