...
| S-03 | [ENCODED-VOD-HOLD-AND-RELEASE](../streaming/ENCODED-VOD-HOLD-AND-RELEASE.md) | §2.6 | week | claimed | gpt-5.6-sol | agent:/root/s01_builder | `plan/S-03` | 2026-09-21 | M0 fleet count first; no implementation before the read-only observation is recorded. |
