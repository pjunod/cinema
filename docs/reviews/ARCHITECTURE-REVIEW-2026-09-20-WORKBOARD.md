...
| S-13 | [DECODE-FACTS-GATE-AND-FALLBACK](../streaming/DECODE-FACTS-GATE-AND-FALLBACK.md) | C13 | month | claimed | gpt-5.6-sol | agent:/root/s01_builder | `plan/S-13` | 2026-09-21 | One whole-plan draft PR; implement M0-M2, then hold M3-M4 behind M0 fleet measurements. |
