...
| S-10 | [HONEST-MASTER-PLAYLIST](../streaming/HONEST-MASTER-PLAYLIST.md) | Q7, A11 | month | blocked: fleet and device evidence | gpt-5.6-sol | agent:/root/p01_builder | [`plan/S-10` · draft #419](http://192.168.4.7:3000/noirr/plurx/pulls/419) | 2026-09-21 | M1/M2 plus sole-review fixes are implemented: rolling and encoded-VOD geometry are coherent, and AVC identity is structurally bound to the selected sample entry. M3 needs per-family 23.976/29.97/59.94/60 SPS evidence; M4 needs named-device SDR `CODECS` re-qualification; M5 needs transcode plus copy/remux/index peak evidence; M6 needs Apple-panel before/after evidence. |
