...
| S-07 | [TONE-MAP-CHAIN-CORRECTIONS](../streaming/TONE-MAP-CHAIN-CORRECTIONS.md) | Q3 | month | claimed | gpt-5.6-sol | agent:/root/c02_builder | `plan/S-07` | 2026-09-21 | M0 is the hwdownload metadata test; whole-plan draft claim, no implementation yet. |
