...
| S-08 | [INTERLACE-IN-THE-MEDIA-CONTRACT](../streaming/INTERLACE-IN-THE-MEDIA-CONTRACT.md) | Q4, Q9 (bitrate half) | month | blocked: fleet evidence | gpt-5.6-sol | agent:/root/s01_builder | [`plan/S-08` · draft #417](http://192.168.4.7:3000/noirr/plurx/pulls/417) | 2026-09-21 | M1–M4 implemented and focused exact-head evidence is green. M5 needs the plan's media1 QSV/VAAPI idet, signalstats and wall-time qualification; hardware graphs remain declined. Adversarial review has not been requested. |
