...
| A-01 | [APPLE-DISPLAY-CRITERIA-AND-AUDIO-SESSION](../clients/APPLE-DISPLAY-CRITERIA-AND-AUDIO-SESSION.md) | §2.8, §2.10 | week | claimed | gpt-5.6-sol | agent:/root/c02_builder | `plan/A-01` | 2026-09-20 | Device tests are GPT prompts in the plan |
