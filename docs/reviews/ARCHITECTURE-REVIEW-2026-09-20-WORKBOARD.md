...
| S-07 | [TONE-MAP-CHAIN-CORRECTIONS](../streaming/TONE-MAP-CHAIN-CORRECTIONS.md) | Q3 | month | in-progress | gpt-5.6-sol | agent:/root/c02_builder | [`plan/S-07` / #416](http://192.168.4.7:3000/noirr/plurx/pulls/416) | 2026-09-21 | M0 measured on shipped FFmpeg 8.1.2: QSV/VA-API keep luminance metadata through download, but linearising zscale drops it; M1/M2 are corrective. M1 implementation next. |
