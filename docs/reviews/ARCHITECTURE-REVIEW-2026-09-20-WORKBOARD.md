...
| S-06 | [ENCODER-RATE-CONTROL-DEFAULTS](../streaming/ENCODER-RATE-CONTROL-DEFAULTS.md) | Q1 | month | claimed | gpt-5.6-sol | agent:/root/p01_builder | [`plan/S-06` / #414](http://192.168.4.7:3000/noirr/plurx/pulls/414) | 2026-09-21 | Per-family evidence first; no universal maxrate cap. |
