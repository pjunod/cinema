...
| K-04 | [BOUNDED-REPLICA-READS-ROLLOUT](../cluster/BOUNDED-REPLICA-READS-ROLLOUT.md) | S1 | month | blocked: fleet evidence | gpt-5.6-sol | agent:/root/c02_builder | [PR #428](http://192.168.4.7:3000/noirr/plurx/pulls/428) | 2026-09-21 | M0 attribution and safe M1 inventory/NodeLocal search implemented. Run the §5.1 lab1–lab3 readout before M2; M2 also needs the acknowledged Raft index surfaced by the write response. Default stays false; no auth cache. |
