...
| P-01 | [RUST-TEST-EXECUTION-POLICY](../ci/RUST-TEST-EXECUTION-POLICY.md) | §2.2, §4.8 | week | claimed | gpt-5.6-sol | agent:/root/p01_builder | `plan/P-01` | 2026-09-20 | Option (a) delegated: `make unit` plus workspace Clippy in the PR fast lane; no periodic schedule |
