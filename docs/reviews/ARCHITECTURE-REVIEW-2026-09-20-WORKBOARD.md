...
| S-12 | [VOD-BFRAMES-TIMELINE-DESIGN](../streaming/VOD-BFRAMES-TIMELINE-DESIGN.md) | Q2 | design | claimed | gpt-5.6-sol | agent:/root/p01_builder | `plan/S-12` · draft PR pending | 2026-09-21 | Design only; current `validate_encoded_fragment` still refuses every nonzero CTO. No implementation or enablement belongs in this PR. |
