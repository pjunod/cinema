...
| C-03 | [IMAGE-SERVING-AND-DERIVATIVES](../server/IMAGE-SERVING-AND-DERIVATIVES.md) | C6 | month | in-progress | gpt-5.6-sol | agent:/root/p01_builder | [PR #431](http://192.168.4.7:3000/noirr/plurx/pulls/431) | 2026-09-21 | M1 focused image tests pass; M2 and deployment/device evidence remain. `original` backdrops are unchanged. |
