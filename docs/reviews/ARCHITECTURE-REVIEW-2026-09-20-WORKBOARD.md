...
| C-05 | [DETAIL-READS-AND-STORAGE-AVAILABILITY](../server/DETAIL-READS-AND-STORAGE-AVAILABILITY.md) | C14 | month | in-progress | gpt-5.6-sol | agent:/root/p01_builder | pending | 2026-09-21 | One plan PR; M1 is the first logical commit and its deployed/backfilled intermediate SHA is mandatory before M2 promotion. Cost and backfill stay node-local in the sidecar, never Raft. |
