...
| C-03 | [IMAGE-SERVING-AND-DERIVATIVES](../server/IMAGE-SERVING-AND-DERIVATIVES.md) | C6 | month | claimed | gpt-5.6-sol | agent:/root/p01_builder | [PR #431](http://192.168.4.7:3000/noirr/plurx/pulls/431) | 2026-09-21 | Keep `original` backdrops; one plan PR owns M1-M2. |
