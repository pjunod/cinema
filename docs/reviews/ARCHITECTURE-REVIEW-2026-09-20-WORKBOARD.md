...
| S-08 | [INTERLACE-IN-THE-MEDIA-CONTRACT](../streaming/INTERLACE-IN-THE-MEDIA-CONTRACT.md) | Q4, Q9 (bitrate half) | month | blocked: fleet evidence | gpt-5.6-sol | agent:/root/s01_builder | [`plan/S-08` · draft #417](http://192.168.4.7:3000/noirr/plurx/pulls/417) | 2026-09-21 | M1–M4 implemented; the sole adversarial review's two P1 findings in [comment 3298](http://192.168.4.7:3000/noirr/plurx/pulls/417#issuecomment-3298) are resolved in `9789ca4ed`, and focused exact-head evidence is green after merging current `main`. M5 still needs the plan's media1 QSV/VAAPI idet, signalstats and wall-time qualification; hardware graphs remain declined. |
