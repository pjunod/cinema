...
| S-09 | [AUDIO-RESOLVED-INDEPENDENTLY](../streaming/AUDIO-RESOLVED-INDEPENDENTLY.md) | Q5 | month | blocked: audio evidence | gpt-5.6-sol | agent:/root/p01_builder | [`plan/S-09` · draft #418](http://192.168.4.7:3000/noirr/plurx/pulls/418) | 2026-09-21 | Sole review #3296 addressed: decoder/sink/passthrough trust is separate; exact source/sink sample-rate evidence gates copy; recipe v4 identifies the 48 kHz decision; flat `achannels` is bounded and progressive AAC remux is pinned. Full M2 still needs normalized source channel layout and M4 matrices before downmix/offline/prepared propagation; M3–M5 need device evidence. No client sends a surround claim. |
