...
| C-01 | [HTTP-LISTENER-TIMEOUTS-AND-ASSET-DELIVERY](../server/HTTP-LISTENER-TIMEOUTS-AND-ASSET-DELIVERY.md) | §2.5, W1, W2, W5, W6 | week | unclaimed | | | | 2026-09-20 | Three logical milestone commits in one plan PR |
| C-02 | [SCAN-AND-ENRICHMENT-HYGIENE](../server/SCAN-AND-ENRICHMENT-HYGIENE.md) | C3, C5 | week | in-progress | gpt-5.6-sol | agent:/root/c02_builder | `plan/C-02` / #400 | 2026-09-20 | M1–M3 implemented and locally verified; draft is ready for exactly one independent adversarial review. |
