...
| C-01 | [HTTP-LISTENER-TIMEOUTS-AND-ASSET-DELIVERY](../server/HTTP-LISTENER-TIMEOUTS-AND-ASSET-DELIVERY.md) | §2.5, W1, W2, W5, W6 | week | claimed | gpt-5.6-sol | agent:/root/c01_builder | `server/http-listener-timeouts` | 2026-09-20 | M1 of three; draft claim PR pending |
