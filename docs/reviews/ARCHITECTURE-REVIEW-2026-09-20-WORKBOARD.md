...
| D-01 | [ANDROID-DISPLAY-MODE-AND-BUFFER-BUDGET](../clients/ANDROID-DISPLAY-MODE-AND-BUFFER-BUDGET.md) | §2.9, D1 | week (measure) / month | blocked: fleet evidence | gpt-5.6-sol | agent:/root/s01_builder | [PR #409](http://192.168.4.7:3000/noirr/plurx/pulls/409) | 2026-09-21 | M1–M3 implemented with focused evidence. The sole adversarial review is complete and both findings are addressed: delayed Live TV tunes are fenced and cleaned by exact session, and the advisory checkbox uses the accepted ordinary-settings payload. M0 needs three-TV ADB measurements; M4 remains gated on those numbers and M5 needs physical HDMI/memory verification. |
