...
| K-05 | [SQLITE-READ-PATH-AND-QUERY-PLANS](../cluster/SQLITE-READ-PATH-AND-QUERY-PLANS.md) | S6, S7, S11 | month | blocked: M0 query-plan evidence | gpt-5.6-sol | agent:/root/c02_builder | [PR #429](http://192.168.4.7:3000/noirr/plurx/pulls/429) | 2026-09-21 | Exact 1.7 GiB standalone fixture generated; M0 still needs an actual Hiqlite state-machine fixture, both-backend plans/timings and the contention matrix. No query/read-path code started. |
