...
| S-12 | [VOD-BFRAMES-TIMELINE-DESIGN](../streaming/VOD-BFRAMES-TIMELINE-DESIGN.md) | Q2 | design | in-progress | gpt-5.6-sol | agent:/root/p01_builder | [`plan/S-12` · draft #423](http://192.168.4.7:3000/noirr/plurx/pulls/423) | 2026-09-21 | Design-only D0–D2 in progress. Current `validate_encoded_fragment` still refuses every nonzero CTO; no implementation, recipe, setting or enablement belongs in this PR. |
