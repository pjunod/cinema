...
| C-04 | [AUTH-HARDENING](../server/AUTH-HARDENING.md) | C7, C8 | month | claimed | gpt-5.6-sol | agent:/root/s01_builder | | 2026-09-21 | Whole-plan draft on `plan/C-04`; preserve the revocation fence. Expiry decision recorded in the plan execution log. |
