...
| C-03 | [IMAGE-SERVING-AND-DERIVATIVES](../server/IMAGE-SERVING-AND-DERIVATIVES.md) | C6 | month | claimed | gpt-5.6-sol | agent:/root/p01_builder | `plan/C-03` (draft PR pending) | 2026-09-21 | Keep `original` backdrops; one plan PR owns M1-M2. |
