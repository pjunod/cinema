...
[CLUSTERING-PLAN-REVIEW.md](../cluster/CLUSTERING-PLAN-REVIEW.md) (the eight contracts)
...
Companion to [CLUSTERING-PLAN.md](../cluster/CLUSTERING-PLAN.md) §3.1–§3.2 and §6.1 —
...
The one-line diff. Base `docs/cluster/CLUSTERING-PLAN.md:31`:
...
`docs/cluster/PHASE3-SPIKE.md:86-89` records machine, OS, Rust version and release
...
Source: `docs/cluster/CLUSTERING-PLAN.md:333-347`.
