...
**Status:** ready to build · **Executes:** the Apple half of M6 ·
...
`docs/M6-CALLER-HANDOFF.md:480`, written 2026-09-02, states that Apple sends
...
arithmetic that web has to invent from scratch (`docs/M6-WEB-CLIENT-BUILD.md` §4).
