...
[VOD-PRESENTATION-PLAN.md](../streaming/VOD-PRESENTATION-PLAN.md),
[CLUSTERING-PLAN.md](../cluster/CLUSTERING-PLAN.md), and
[CLUSTER-MEDIA-POOL-PLAN.md](../cluster/CLUSTER-MEDIA-POOL-PLAN.md). The independent
finding ledger is
...
The existing [ADAPTIVE-QUALITY.md](../streaming/ADAPTIVE-QUALITY.md) thresholds are the
