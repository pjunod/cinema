...
[ADAPTIVE-QUALITY.md](../streaming/ADAPTIVE-QUALITY.md) (the ABR design this plan
partially executes), [ARCHITECTURE.md](../ARCHITECTURE.md) §3,
[PHASE3-SPIKE.md](../cluster/PHASE3-SPIKE.md) (the failover property M4 builds on).
...
- **B6 — unbounded hardware bitrate.** QSV/VA-API/VideoToolbox get bare
  ...
  [ADAPTIVE-QUALITY.md](../streaming/ADAPTIVE-QUALITY.md) already calls "the one real
...
([PHASE3-SPIKE.md](../cluster/PHASE3-SPIKE.md)) holds for any fixed segment length;
...
[ADAPTIVE-QUALITY.md](../streaming/ADAPTIVE-QUALITY.md) Phase 1, promoted here because
...
paragraph (§4.2 obsoletes both) · [ADAPTIVE-QUALITY.md](../streaming/ADAPTIVE-QUALITY.md)
