...
[ADAPTIVE-QUALITY.md](../streaming/ADAPTIVE-QUALITY.md). It records the current code-quality
...
[PERF-PLAN.md](PERF-PLAN.md) and
[ADAPTIVE-QUALITY.md](../streaming/ADAPTIVE-QUALITY.md) are the right direction. Implement
