...
- Prior project evidence:
  [PHASE3-SPIKE.md](../cluster/PHASE3-SPIKE.md),
...
([PHASE3-SPIKE.md](../cluster/PHASE3-SPIKE.md):223-277). PERF's accepted failover
...
problems
([ADAPTIVE-QUALITY.md](../streaming/ADAPTIVE-QUALITY.md):155-175).
