...
[ADAPTIVE-QUALITY.md](../streaming/ADAPTIVE-QUALITY.md) Phase 2 · **Written:** 2026-08-09
...
- **B23 — much of the 4K DV library may still miss the GPU tone-map.**
  At the 2026-07-29 census (PERF-PLAN §5, `docs/performance/PERF-PLAN.md:1119-1131`),
...
top rung to bridge live-session spin-up)" (`docs/performance/PERF-PLAN.md:1416-1420`).
...
terminal error." This executes [ADAPTIVE-QUALITY.md](../streaming/ADAPTIVE-QUALITY.md)
...
(`docs/streaming/ADAPTIVE-QUALITY.md` carries the recovery rule). The web controller now
...
- **The tripwire is load-bearing:** the exhaustive
  ...
  ([MEDIA-BADGES-PLAN.md](../streaming/MEDIA-BADGES-PLAN.md) §2.1) must be updated
