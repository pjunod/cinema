...
| M4 cluster | partial | Protocol 7 advertises bounded path-free drive ownership and remote discovery with typed no-relay refusal; [M4 evidence](../evidence/OPTICAL-M4-2026-09-21.md). Authenticated relay, owner-only placement and owner-loss acceptance remain open. |
