...
| M6 native | partial | Commit `09cf7414` adds path-free optical models and APIs, authorized Home discovery, disc/title navigation, resume, chapters, track selection, session progress and teardown on Apple and Android. Build 174 compiles for iOS/tvOS and build 112 assembles for Android; [M6 evidence](../evidence/OPTICAL-M6-2026-09-21.md). Integration with each established full player and physical focus/Picture in Picture/device acceptance remain open. |
