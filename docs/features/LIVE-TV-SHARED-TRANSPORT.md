...
(Decided the same day — option (b), recorded under D7 — and M1 built
against D1–D8; see "As built in M1" below.)
...
| 2026-09-25 | gpt-6 | current integration clone | M2 | [draft #506](http://192.168.4.7:3000/noirr/plurx/pulls/506) | Added one `tuner_capacity` fixture with two `watchable` rows and web, Apple and Android offers. Web binds a direct “Watch 2.1 instead” action to a playable lineup row; native refusal copy names both watchable channels. Compile and device acceptance remain due. |
| 2026-09-25 | gpt-6 / agent capture | agent:/root/d02_remaining and agent:/root/restore_d03 | M4 broadcast evidence and build | `codex/l03-caption-probe` | Prompt A was captured on the real HDHomeRun at `192.168.5.191` on nynuc: 6.1 WTVR-HD, 6.2 CBS6XTR and 12.2 12 MeTV all carried CC1 and 708 SERVICE1. Exact analyzer output is below. Their shared service IDs permit M4 to name those two tracks; CC3 was not present on all three, and SERVICE2–6 had no text. M4 runs the M3 captioned fixture through each available encoder, deinterlace mode and supported output height on this node's FFmpeg build at boot. A master advertises captions only after its exact graph preserves both formats; other graphs report `CLOSED-CAPTIONS=NONE`. The branch has compile-only evidence; user-directed fast lane and sole adversarial review await consolidated promotion. Prompt C client baseline and the §6.3 M4 device pass remain owed. |
| 2026-09-24 | — | — | needs: broadcast capture | — | *Satisfied 2026-09-25 by the M4 evidence row and exact capture record below.* |
...
| 2026-09-25 | gpt-6 / coordinator | agent:/root | Prompt C partial baseline | — | On current `main`, Chrome playing 6.1 through Intel QuickSync at 1080p exposed an active video English caption track, but the track stayed hidden and no text was drawn after more than 30 seconds. All tuners were idle afterward. Safari, Apple TV, iPhone, Android TV and Android phone observations remain owed; this Chrome result alone does not satisfy the full client baseline or M4 device pass. |
| 2026-09-24 | — | — | needs: client baseline | — | *Partially sampled on Chrome 2026-09-25; other clients remain owed, as recorded above.* |

#### M4 broadcast capture record (prompt A)

The 2026-09-25 sample was taken from the tuner owner nynuc before M4
advertising. All three 30-second captures were deleted after analysis; all four
tuners were idle afterward. These are the exact `ffprobe` and
`caption-capture` values reported by the analyzer:

| Channel | `ffprobe` video, field order, rate | Frames with CC | CC1 | CC3 | 708 SERVICE1 | Other 708 services |
|---|---|---:|---|---|---|---|
| 6.1 WTVR-HD | `mpeg2video,tt,30000/1001,` | 887 | 373 chars; `foart atr th.Well, then,what are you worried about?That she ain't that smartand she's gonna date him!Come on, he can't keep upthis nice guy act for long.You're ` | 757 chars; `*  SCBCBS  *  *CBS  *CBS  *CBS  *CBS  *CBS  *CBS  *CBS  *CBS  *CBS  *CBS  *CBS  *CBS  *CBS  *CBS  *CBS  *CBS  *CBS  *C` | 394 chars; `t smarthfor .at*Well, then,*what are you worried about?*That she ain't that smart*and she's gonna date him!*Come on, he can't keep up*this nice guy act for long` | SERVICE2–6: each 0 chars, empty sample |
| 6.2 CBS6XTR | `mpeg2video,tt,30000/1001,` | 841 | 373 chars; ` Up next,Russell Crowe on playingthe man who helped moldthe Unabomber, the ideathat bombs would arrivein the mail wasterrifying. And the kidfrom room all grown ` | 18 chars; `HD_HD_HD_HD_HD_HD_` | 402 chars; ` Up next, Russell Crowe on playing the man who helped mold the Unabomber, the idea that bombs would arrive in the mail was terrifying. And the kid from room all` | No nonzero service beyond SERVICE1 |
| 12.2 12 MeTV | `mpeg2video,tt,30000/1001,` | 875 | 229 chars; `We're all out of fresh pepper.Do you have any more?Oh, yeah. In the pantry.In the back.Oh, boy.This chicken looks great.Girls, Count Bessie is missing!I went ou` | 0 chars; empty sample | 254 chars; `A*We're all out of fresh pepper.A*Do you have any more?A**Oh, yeah. In the pantry.A*In the back.A**Oh, boy.A*This chicken looks great.F*Girls, Count Bessie is m` | No nonzero service beyond SERVICE1 |

The seven candidate H.264 subchannels sampled for five seconds each (23.4,
28.1, 30.1, 45.1, 48.1, 53.1 and 65.6) were all MPEG-2. H.264 broadcast
service evidence is still absent; the boot proof therefore advertises only
MPEG-2 encode graphs, with copy and other source families unadvertised.
