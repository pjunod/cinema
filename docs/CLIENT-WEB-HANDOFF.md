...
**Status:** ready to build, message plumbing only · **Exclusive lock:** you own
...
Read `docs/CLIENT-PREPARED-SWITCH-CONTRACT.md` in the repo first — it is the
...
Full detail in `docs/CLIENT-PREPARED-SWITCH-CONTRACT.md`. The web-shaped
summary:
