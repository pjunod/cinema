...
| Next | Obtain exact-head adversarial approval for both pending directions · rerun the effort gate · mark ready and merge into the effort without a task-level full-suite run |
