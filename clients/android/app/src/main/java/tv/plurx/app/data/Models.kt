...
data class Marker(
    ...
    val isAutoSkipEligible: Boolean
        get() = when {
            kind == "preview" -> false
            provenance == null -> chapter
            provenance == "authored" || provenance == "manual" -> true
            else -> false
        }
...
data class PlaybackSessionStatus(
    ...
    val startup_state: String? = null,
    val startup_remaining_ms: Long? = null,
    val presentation_progress_seen: Boolean? = null,
    val produced_end_ms: Long? = null,
    val served_end_ms: Long? = null,
    val staged_bytes: Long? = null,
    val playlist_target_ms: Long? = null,
    val served_revision: Long? = null,
    val last_segment_advanced_idle_ms: Long? = null,
    val next_publication_in_ms: Long? = null,
    val publication_deadline_remaining_ms: Long? = null,
    val maintenance_state: String? = null,
    val rate_estimate_source: String? = null,
    val estimate_active_speed: Double? = null,
    val pause_grace_remaining_ms: Long? = null,
    val retirement_reason: String? = null,
    val advertised_bytes: Long? = null,
    val grace_bytes: Long? = null,
    val reserved_bytes: Long? = null,
    val live_bytes: Long? = null,
    ...
    val control_demand: String? = null,
    val reported_position_ms: Long? = null,
    val client_runway_ms: Long? = null,
    val render_state: String? = null,
    val server_ready_state: String? = null,
    val server_ready_anchor_ms: Long? = null,
    val server_ready_end_ms: Long? = null,
    val server_ready_seconds: Double? = null,
    val server_next_ready_start_ms: Long? = null,
    val server_next_ready_end_ms: Long? = null,
    val production_policy: String? = null,
    val production_ahead_seconds: Long? = null,
    val production_target_seconds: Long? = null,
    val producer_state: String? = null,
    ...
    val http_wait_count: Long? = null,
    val http_wait_oldest_ms: Long? = null,
    val http_wait_segment: Long? = null,
    val status_generated_unix_ms: Long? = null,
...
@Serializable
data class DecisionCapsReq(val caps: DeviceCaps)
