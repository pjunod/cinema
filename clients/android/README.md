...
> and TV. Build 80 adds Library channel browsing and authoring plus fenced
> finite-HLS following. Build 79 adds three saved Google TV layouts around one
> Media3 player, six-hour guide browsing, compact phone schedules, exact-once
> D-pad delegation, and measured source-format details. Library-channel readiness remains advisory in
> Settings → Developer and never overrides the explicit enable. Build 78 labels
> Live TV channel format and reports live tuner signal
