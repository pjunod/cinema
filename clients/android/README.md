...
> Status: **v0.3.0**, build `126` — playback information separates source frame,
> measured or planned stream frame, and player display size. Build 125 preserves
> native viewer parity across phone, foldable, and TV. Build 124 settles a progressive remux seek after later rendered video
