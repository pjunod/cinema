...
class CiCacheContractCase(unittest.TestCase):
    ...
    def test_cargo_cache_is_local_on_every_self_hosted_runner(self):
        ...
        self.assertIn("uses: https://github.com/Swatinem/rust-cache@49a0bdc70d2e1b713ca9e2869b211fcce03d3c1c", action)
        self.assertNotIn("uses: https://github.com/Swatinem/rust-cache@49a0bdc70d2e1b713ca9e2869b211fcce03d3c1c", workflow)
